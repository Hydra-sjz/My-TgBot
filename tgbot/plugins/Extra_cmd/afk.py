...
from tgbot.utils.Database.afk_db import add_afk, cleanmode_off, cleanmode_on, is_afk, remove_afk
from tgbot.utils.helper.human_read import get_readable_time2
from tgbot.utils.helper.utils import put_cleanmode


#[<code>{}</code>]
# Handle set AFK Command
@app.on_message(filters.command(["afk"], CMD))
