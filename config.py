...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Hydra92074:Hydra92074@cluster0.ixbo9.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DB_NAME", "X-module")
BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", True))
GEMINI_API = os.getenv('GEMINI_API', "AIzaSyBd-1CjNDdyfgOe3iFb2vv3KOHGwlkG7wE")
HEROKU_API_KEY = environ.get("HEROKU_API_KEY", "")
BT_STRT_TM = time.time()

SPOTIPY_CLIENT_ID = os.environ.get("SPOTIPY_CLIENT_ID", "3897229c442f411d913a41194ce021bd")
SPOTIPY_CLIENT_SECRET = os.environ.get("SPOTIPY_CLIENT_SECRET", "36ed57b8e8c54d808e4512f4812c9da6")
...
#API_TOOLS
CURRENCY_API = environ.get("CURRENCY_API", "61739427b3783e54440601fa")
GPT_API = os.environ.get("GPT_API")
DAXX_API = os.environ.get("DAXX_API")
DEEP_API = os.environ.get("DEEP_API", "3de9e9e3-025a-48f5-9188-9b29a5f3204b")
UNSPLASH_ACCESS_KEY = os.getenv('UNSPLASH_ACCESS_KEY','')
GENIUS_API = os.getenv('GEMINI_API', "AIzaSyBd-1CjNDdyfgOe3iFb2vv3KOHGwlkG7wE")
GEMINI_API = os.getenv('GEMINI_API', "AIzaSyBd-1CjNDdyfgOe3iFb2vv3KOHGwlkG7wE")
